...
public class Client1 extends Thread implements ActionListener{
    /**
	 * 
	 */
	 ...
	 public Client1(int port,String ipAddress,String sharedFilePath,String outputPath) 
	    { 
		 this.port = port;
    ...
    {
		new Client1(2222,"localhost","input1","output1");
